 ...
 * @author elker
 */
public class JFTramite extends javax.swing.JFrame {
    ...
    public String getCelular(){
        return dt.getCelular();
    }
    public String getPrioridad(){
        return dt.getPrioridad();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SELECCIONE EL TRAMITE QUE DESEA REALIZAR");

        cboxTramite.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tramites en caja", "Sacar un producto", "Ayuda con tus productos", "Cancela un producto", "Pedir documentos" }));
        cboxTramite.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboxTramiteActionPerformed(evt);
            }
        });

        btnFinalizarTurno.setText("Continuar");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(78, 78, 78)
                        .addComponent(cboxTramite, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(102, 102, 102)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel1)
                .addGap(60, 60, 60)
                .addComponent(cboxTramite, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(68, 68, 68)
                .addComponent(btnFinalizarTurno)
    ...
    private void cboxTramiteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboxTramiteActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cboxTramiteActionPerformed
...
//            java.util.logging.Logger.getLogger(JFTramite.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
